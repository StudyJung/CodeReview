...
| 항목 | 내용 |
| :--- | :--- |
| **누적 Output** | CodeReview_20260420_1776649492.md |
| **Period** | 2026/04/19 23:17:12 - 2026/04/20 10:00:00 |
...
```
 <details>
  <summary>상태 : [미결] , 위험 : 99, 횟수 : 4, 추적 : 2026/04/19 - 2026/04/20</summary>
...
```
 <details>
  <summary>상태 : [미결] , 위험 : 95, 횟수 : 9, 추적 : 2026/04/19 - 2026/04/20</summary>
...
```
 <details>
  <summary>상태 : [미결] , 위험 : 90, 횟수 : 8, 추적 : 2026/04/19 - 2026/04/20</summary>
...
```
 <details>
  <summary>상태 : [미결] , 위험 : 88, 횟수 : 6, 추적 : 2026/04/19 - 2026/04/20</summary>
...
```
 <details>
  <summary>상태 : [미결] , 위험 : 85, 횟수 : 9, 추적 : 2026/04/19 - 2026/04/20</summary>
