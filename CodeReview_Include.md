...
```
 <details>
  <summary>상태 : [해결] , 위험 : 95, 횟수 : 3, 추적 : 2026/04/19 - 2026/04/19</summary>
 ...
 - 사유 : commit 17d38f8 에서 `//printf("T4 %d.\n ", *pT);` 로 주석 처리되어 활성 크래시 경로 제거됨. 단, `pT = nullptr` 선언 및 주석 라인 잔존으로 재활성 리스크 존재. 현재 소스에서 주석 라인도 완전 제거되어 활성 크래시 경로 해소됨
...
```
 <details>
  <summary>상태 : [미결] , 위험 : 80, 횟수 : 7, 추적 : 2026/04/19 - 2026/04/19</summary>
...
```
 <details>
  <summary>상태 : [미결] , 위험 : 70, 횟수 : 4, 추적 : 2026/04/19 - 2026/04/19</summary>
