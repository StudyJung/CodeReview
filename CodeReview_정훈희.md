# CodeReview_정훈희.md
- "최고의 디버거는 꼼꼼한 코드 리뷰다." - 무명

## 요약
| 항목 | 내용 |
| :--- | :--- |
| **Source** | CodeReview_Include.md (P0-P1 미결) |
| **Period** | 2026/04/19 22:09:25 - 2026/04/20 08:09:37 |
...
```
 <details>
  <summary>상태 : [미결] , 위험 : 99, 횟수 : 3, 추적 : 2026/04/19 - 2026/04/19</summary>
...
```
 <details>
  <summary>상태 : [미결] , 위험 : 95, 횟수 : 5, 추적 : 2026/04/19 - 2026/04/19</summary>
...
#### [P0:Include missing][정훈희][203c200][Test.cpp/global/Line:1]
...
```
 <details>
  <summary>상태 : [미결] , 위험 : 90, 횟수 : 4, 추적 : 2026/04/19 - 2026/04/19</summary>
...
#### [P0:Include missing][정훈희][203c200][Test.h/global/Line:3]
...
```
 <details>
  <summary>상태 : [미결] , 위험 : 88, 횟수 : 2, 추적 : 2026/04/19 - 2026/04/19</summary>
...
#### [P0:Undefined symbol][정훈희][203c200][Test.cpp/TEST()/Line:9]
...
```
 <details>
  <summary>상태 : [미결] , 위험 : 85, 횟수 : 5, 추적 : 2026/04/19 - 2026/04/19</summary>
